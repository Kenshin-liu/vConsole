<script lang="ts">
  ...
  const prettyStringify = (value: any) => {
    if (tool.isObject(value) || tool.isArray(value)) {
      return tool.safeJSONStringify(value, {
        maxDepth: 10,
        keyMaxLen: 10000,
        pretty: true,
      });
    ...
    >
      <svelte:fragment slot="header">
        <dl class="vc-table-row">
          <dd class="vc-table-col vc-table-col-4">
            Name {#if reqCount > 0}({reqCount}){/if}
          </dd>
      ...
      <div
        ...
        let:item={req}
        class="vc-group"
        class:vc-actived={req.actived}
        id={req.id}
      >
        <dl
          class="vc-table-row vc-group-preview"
          class:vc-table-row-error={req.status >= 400 || req.retCode !== "0"}
          on:click={() => onTapPreview(req.id)}
        >
            ...
            <dl class="vc-table-row vc-left-border">
              <dt class="vc-table-col vc-table-col-title">
                ...
                <i class="vc-table-row-icon"
                  ><IconCopy handler={onCopyCurl} content={req} /></i
                >
              </dt>
            </dl>
            ...
            <div>
              <dl class="vc-table-row vc-left-border">
                <dt class="vc-table-col vc-table-col-title">
                  Request Headers
                  <i class="vc-table-row-icon"
                    ><IconCopy content={req.requestHeader} /></i
                  >
                </dt>
              </dl>
            ...
            <div>
              <dl class="vc-table-row vc-left-border">
                <dt class="vc-table-col vc-table-col-title">
                  ...
                  <i class="vc-table-row-icon"
                    ><IconCopy content={req.getData} /></i
                  >
                </dt>
              </dl>
            ...
            <div>
              <dl class="vc-table-row vc-left-border">
                <dt class="vc-table-col vc-table-col-title">
                  Request Payload
                  <i class="vc-table-row-icon"
                    ><IconCopy content={req.postData} /></i
                  >
                </dt>
              </dl>
              {#if typeof req.postData === "string"}
                <div class="vc-table-row vc-left-border vc-small">
                  <pre
                    ...
                    data-scrollable="1">{req.postData}</pre>
                </div>
              {:else}
          ...
          <div>
            <dl class="vc-table-row vc-left-border">
              <dt class="vc-table-col vc-table-col-title">
                Response
                <i class="vc-table-row-icon"
                  ><IconCopy content={req.response} /></i
                >
              </dt>
            </dl>
